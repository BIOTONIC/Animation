...
//current output directory is cmake-build-debug
const GLchar *vertexShaderFile = "../shaders/animation.vert";
const GLchar *fragmentShaderFile = "../shaders/animation.frag";
//const GLchar *vertexShaderFile = "/Users/lovejoy/Developer/Animation/shaders/animation.vert";
//const GLchar *fragmentShaderFile = "/Users/lovejoy/Developer/Animation/shaders/animation.frag";
...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        cubeMat = glm::translate(cubeMat, glm::vec3(0.5f * cos(glfwGetTime()), 0.5f * sin(glfwGetTime()),
                                                    0.5f * cos(glfwGetTime()) * sin(glfwGetTime())));
        cubeMat = glm::rotate(cubeMat, (GLfloat) glfwGetTime(), glm::vec3(1.0f, 1.0f, 1.0f));
        cubeMat = glm::scale(cubeMat,
                             glm::vec3(1.0f + .5f * cos(glfwGetTime() * 3), 1.0f + .5f * cos(glfwGetTime() * 3),
                                       1.0f + .5f * cos(glfwGetTime() * 3)));
